...
const TRACKS_DATA = {
    monza: {
        ...
        difficulty: 3, // 1-5
        image: 'img/tracks/image-tracks/monza-2d-model-msmanager.jpg',
        thumbnail: 'img/tracks/race-tracks/monza.png',
        ...
        racingLinePath: `M 250.0,294.5 L 272.2,294.5 L 294.4,294.5 L 316.7,294.5 L 330.6,294.5 L 344.4,294.5 L 358.3,294.5 L 363.9,294.5 L 369.4,294.5 L 375.0,294.5 L 379.2,288.2 L 383.3,281.8 L 387.5,275.5 L 383.3,269.2 L 379.2,262.8 L 375.0,256.5 L 372.2,253.3 L 369.4,250.2 L 366.7,247.0 L 369.4,240.7 L 372.2,234.3 L 375.0,228.0 L 380.6,224.8 L 386.1,221.7 L 391.7,218.5 L 397.2,215.3 L 402.8,212.2 L 408.3,209.0 L 413.9,205.8 L 419.4,202.7 L 425.0,199.5 L 425.0,193.2 L 425.0,186.8 L 425.0,180.5 L 419.4,177.3 L 413.9,174.2 L 408.3,171.0 L 402.8,169.4 L 397.2,167.8 L 391.7,166.2 L 377.8,169.4 L 363.9,172.6 L 350.0,175.8 L 336.1,180.5 L 322.2,185.2 L 308.3,190.0 L 294.4,193.2 L 280.6,196.3 L 266.7,199.5 L 252.8,199.5 L 238.9,199.5 L 225.0,199.5 L 216.7,196.3 L 208.3,193.2 L 200.0,190.0 L 194.4,183.7 L 188.9,177.3 L 183.3,171.0 L 177.8,174.2 L 172.2,177.3 L 166.7,180.5 L 158.3,186.8 L 150.0,193.2 L 141.7,199.5 L 130.6,209.0 L 119.4,218.5 L 108.3,228.0 L 100.0,234.3 L 91.7,240.7 L 83.3,247.0 L 80.6,253.3 L 77.8,259.7 L 75.0,266.0 L 80.6,272.3 L 86.1,278.7 L 91.7,285.0 L 97.2,288.2 L 102.8,291.3 L 108.3,294.5 L 111.1,300.8 L 113.9,307.2 L 116.7,313.5 L 111.1,316.7 L 105.6,319.8 L 100.0,323.0 L 94.4,323.0 L 88.9,323.0 L 83.3,323.0 L 80.6,316.7 L 77.8,310.3 L 75.0,304.0 L 83.3,300.8 L 91.7,297.7 L 100.0,294.5 L 116.7,294.5 L 133.3,294.5 L 150.0,294.5 L 166.7,294.5 L 183.3,294.5 L 200.0,294.5 L 216.7,294.5 L 233.3,294.5 Z`,
    ...
    leoverse: {
        ...
        type: 'technical',
        difficulty: 4,
        image: 'img/tracks/image-tracks/bahrain-2d-model-msmanager.jpg',
        thumbnail: 'img/tracks/race-tracks/bahrain.png',
        characteristics: {
            topSpeed: 320,
            avgSpeed: 205,
            downforce: 'medium',
    ...
    melbourne: {
        ...
        type: 'street',
        difficulty: 4,
        image: 'img/tracks/image-tracks/melbourne-2d-model-msmanager.jpg',
        thumbnail: 'img/tracks/race-tracks/melbourne.png',
        characteristics: {
            topSpeed: 318,
            avgSpeed: 198,
            downforce: 'medium',
        ...
        waypoints: [
            { id: 0, x: 250.0, y: 294.5, type: 'start', speed: 200, throttle: 0.8, brake: 0.1 },
            { id: 1, x: 358.3, y: 294.5, type: 'drs-start', speed: 200, throttle: 0.8, brake: 0.1, drs: true },
            { id: 2, x: 387.5, y: 275.5, type: 'straight', speed: 200, throttle: 0.8, brake: 0.1, drs: true },
            { id: 3, x: 366.7, y: 247.0, type: 'brake', speed: 200, throttle: 0.8, brake: 0.1, corner: 'Jones' },
            { id: 4, x: 391.7, y: 218.5, type: 'apex', speed: 200, throttle: 0.8, brake: 0.1 },
            { id: 5, x: 425.0, y: 199.5, type: 'exit', speed: 200, throttle: 0.8, brake: 0.1 },
            { id: 6, x: 408.3, y: 171.0, type: 'straight', speed: 200, throttle: 0.8, brake: 0.1 },
            { id: 7, x: 350.0, y: 175.8, type: 'apex', speed: 200, throttle: 0.8, brake: 0.1, corner: 'Brabham' },
            { id: 8, x: 266.7, y: 199.5, type: 'exit', speed: 200, throttle: 0.8, brake: 0.1 },
            { id: 9, x: 200.0, y: 190.0, type: 'straight', speed: 200, throttle: 0.8, brake: 0.1 },
            { id: 10, x: 166.7, y: 180.5, type: 'apex', speed: 200, throttle: 0.8, brake: 0.1, corner: 'Lauda' },
            { id: 11, x: 108.3, y: 228.0, type: 'straight', speed: 200, throttle: 0.8, brake: 0.1, drs: true },
            { id: 12, x: 75.0, y: 266.0, type: 'drs-end', speed: 200, throttle: 0.8, brake: 0.1 },
            { id: 13, x: 108.3, y: 294.5, type: 'brake', speed: 200, throttle: 0.8, brake: 0.1, corner: 'Ascari' },
            { id: 14, x: 100.0, y: 323.0, type: 'apex', speed: 200, throttle: 0.8, brake: 0.1 },
            { id: 15, x: 75.0, y: 304.0, type: 'exit', speed: 200, throttle: 0.8, brake: 0.1 },
            { id: 16, x: 150.0, y: 294.5, type: 'finish', speed: 200, throttle: 0.8, brake: 0.1 }
        ],
        racingLinePath: `M 250.0,294.5 L 272.2,294.5 L 294.4,294.5 L 316.7,294.5 L 330.6,294.5 L 344.4,294.5 L 358.3,294.5 L 363.9,294.5 L 369.4,294.5 L 375.0,294.5 L 379.2,288.2 L 383.3,281.8 L 387.5,275.5 L 383.3,269.2 L 379.2,262.8 L 375.0,256.5 L 372.2,253.3 L 369.4,250.2 L 366.7,247.0 L 369.4,240.7 L 372.2,234.3 L 375.0,228.0 L 380.6,224.8 L 386.1,221.7 L 391.7,218.5 L 397.2,215.3 L 402.8,212.2 L 408.3,209.0 L 413.9,205.8 L 419.4,202.7 L 425.0,199.5 L 425.0,193.2 L 425.0,186.8 L 425.0,180.5 L 419.4,177.3 L 413.9,174.2 L 408.3,171.0 L 402.8,169.4 L 397.2,167.8 L 391.7,166.2 L 377.8,169.4 L 363.9,172.6 L 350.0,175.8 L 336.1,180.5 L 322.2,185.2 L 308.3,190.0 L 294.4,193.2 L 280.6,196.3 L 266.7,199.5 L 252.8,199.5 L 238.9,199.5 L 225.0,199.5 L 216.7,196.3 L 208.3,193.2 L 200.0,190.0 L 194.4,183.7 L 188.9,177.3 L 183.3,171.0 L 177.8,174.2 L 172.2,177.3 L 166.7,180.5 L 158.3,186.8 L 150.0,193.2 L 141.7,199.5 L 130.6,209.0 L 119.4,218.5 L 108.3,228.0 L 100.0,234.3 L 91.7,240.7 L 83.3,247.0 L 80.6,253.3 L 77.8,259.7 L 75.0,266.0 L 80.6,272.3 L 86.1,278.7 L 91.7,285.0 L 97.2,288.2 L 102.8,291.3 L 108.3,294.5 L 111.1,300.8 L 113.9,307.2 L 116.7,313.5 L 111.1,316.7 L 105.6,319.8 L 100.0,323.0 L 94.4,323.0 L 88.9,323.0 L 83.3,323.0 L 80.6,316.7 L 77.8,310.3 L 75.0,304.0 L 83.3,300.8 L 91.7,297.7 L 100.0,294.5 L 116.7,294.5 L 133.3,294.5 L 150.0,294.5 L 166.7,294.5 L 183.3,294.5 L 200.0,294.5 L 216.7,294.5 L 233.3,294.5 Z`,
    ...
    shanghai: {
        ...
        type: 'technical',
        difficulty: 5,
        image: 'img/tracks/image-tracks/shanghai-2d-model-msmanager.jpg',
        thumbnail: 'img/tracks/race-tracks/shanghai.png',
        characteristics: {
            topSpeed: 305,
            avgSpeed: 182,
            downforce: 'high',
    ...
    portimao: {
        ...
        type: 'technical',
        difficulty: 4,
        image: 'img/tracks/image-tracks/portimao-2d-model-msmanager.jpg',
        thumbnail: 'img/tracks/race-tracks/portimao.png',
        characteristics: {
            topSpeed: 310,
            avgSpeed: 190,
            downforce: 'high',
    ...
    montmelo: {
        ...
        type: 'technical',
        difficulty: 4,
        image: 'img/tracks/image-tracks/montmelo-2d-model-msmanager.jpg',
        thumbnail: 'img/tracks/race-tracks/montmelo.png',
        characteristics: {
            topSpeed: 320,
            avgSpeed: 195,
            downforce: 'high',
    ...
    nurburgring: {
        ...
        type: 'mixed',
        difficulty: 3,
        image: 'img/tracks/image-tracks/nurburgring-2d-model-msmanager.jpg',
        thumbnail: 'img/tracks/race-tracks/nurburgring.png',
        characteristics: {
            topSpeed: 315,
            avgSpeed: 200,
            downforce: 'medium',
