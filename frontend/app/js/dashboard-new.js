...
class DashboardController {
    ...
    bindEvents() {
        ...
        document.getElementById('card-career')?.addEventListener('click', () => {
            if (document.getElementById('card-career')?.classList.contains('locked')) return;
            window.location.href = 'online.html';
        });
        
        document.getElementById('card-community')?.addEventListener('click', () => {
            if (document.getElementById('card-community')?.classList.contains('locked')) return;
        ...
        document.getElementById('card-league')?.addEventListener('click', () => {
            if (document.getElementById('card-league')?.classList.contains('locked')) return;
            window.location.href = 'league.html';
        });
        ...
        document.querySelector('.strategy-btn')?.addEventListener('click', () => {
            // Bloqueado – modo online en mantenimiento
        });
    }
