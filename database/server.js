...
const corsOptions = {
  origin:
    process.env.NODE_ENV === "production"
      ? [process.env.FRONTEND_URL, process.env.BACKEND_URL, /\.onrender\.com$/]
      : "*",
  credentials: true,
...
app.use(
  /^\/api\/social\/quick-races\/\d{5}\/live-state$/,
  multiplayerLiveStateLimiter,
);
app.use(
  /^\/api\/online\/leagues\/[^/]+\/race\/live-state$/,
  multiplayerLiveStateLimiter,
);
